  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className={`px-4 py-2 rounded-md inline-flex items-center text-sm font-medium ${canFulfillAll
          ...
          >
            <div>
              <div className="flex items-center">
                ...
                <p className='flex text-sm text-gray-500 dark:text-gray-300'>({order.branchProduct.product.code})</p>
            ...
            <div className="flex items-center dark:text-gray-200 ml-4">
