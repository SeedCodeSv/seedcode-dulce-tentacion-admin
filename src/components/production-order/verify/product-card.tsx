...
const ProductCard: React.FC<ProductCardProps> = ({ detail, status }) => {
  ...
  return (
    <div className="bg-white shadow overflow-hidden sm:rounded-lg transition-all duration-300 hover:shadow-md">
      <div
      ...
      >
        <div>
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-500">({detail.products.code})</span>
            {status.canFulfill ? (
