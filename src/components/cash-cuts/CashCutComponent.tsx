...
export default function CashCutComponent({ branch, params, data, buttons }: PropsCashCut) {
          ...
          <table className="w-full" >
            <tbody>
              ...
              <tr>
                ...
                <td className="text-right">{formatCurrency(
                  calcTotal(
                    data.totalSales01Card ?? 0,
                    data.totalSales03Card ?? 0
                  )
                )}</td>
              </tr>
              <tr>
                ...
                <td className="text-right">{formatCurrency(
                  calcTotal(
                    data.totalSales01Cash ?? 0,
                    data.totalSales03Cash ?? 0
                  )
                )}</td>
              </tr>
              <tr>
          ...
          <table className="mt-3 w-full">
            ...
            <tbody>
              ...
              <tr className="min-h-8 h-full">
                ...
                <td className="text-sm text-right">
                  {formatCurrency(
                    Number(data.invalidation03 ?? 0) +
                    Number(data.invalidation01 ?? 0)
                  )}
                </td>
              </tr>
              <tr className="min-h-8 h-full">
