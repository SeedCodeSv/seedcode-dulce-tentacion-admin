...
function MobileView({ layout, deletePopover, handleEdit, actions, handleActive }: Props) {
    ...
    <div className="w-full pb-10">
      <DataView
        ...
        itemTemplate={(cat, layout) =>
          gridItem(cat, layout as 'grid' | 'list', deletePopover, handleEdit, actions, handleActive)
        }
