    ...
    <div className="w-full ">
      <DataView
        ...
        pt={{
          grid: () => ({
            className:
              "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 grid-nogutter gap-5",
          }),
        }}
      ...
      {layout === 'grid' ? (
        <div
          ...
          className={classNames(
            'w-full lg:ml-96 md:ml-48 xl:ml-96 flex flex-col border items-center shadow-sm hover:shadow-lg p-8 dark:border dark:border-gray-600 rounded-2xl'
          )}
        >
