...
export const generate_credit_factura = (
  transmitter: ITransmitter,
  next_number: number,
  valueTipo: ITipoDocumento,
  cantidad: number,
  ...
  return {
    ...
    dteJson: {
      ...
      cuerpoDocumento: [{
        ...
        ventaNoSuj: 0,
        ventaExenta: 0,
        ventaGravada: cantidad,
        ivaItem: (cantidad + interes) / 1.13,
        tributos: null,
        psv: 0,
        noGravado: 0,
      }],
      resumen: {
        totalNoSuj: 0,
        totalExenta: 0,
        totalGravada: Number(cantidad.toFixed(2)),
        subTotalVentas: Number(cantidad.toFixed(2)),
        descuNoSuj: 0,
        descuExenta: 0,
        descuGravada: 0,
        ...
        totalDescu: 0,
        tributos: null,
        subTotal: Number(cantidad.toFixed(2)),
        ivaRete1: 0,
        reteRenta: 0,
        totalIva: Number(cantidad.toFixed(2)),
        montoTotalOperacion: Number(cantidad.toFixed(2)),
        totalNoGravado: 0,
        totalPagar: Number(cantidad.toFixed(2)),
        totalLetras: convertCurrencyFormat(cantidad.toFixed(2)),
        saldoFavor: 0,
        condicionOperacion: 1,
        pagos: tipo_pago,
        numPagoElectronico: null,
