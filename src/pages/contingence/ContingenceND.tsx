...
import { firmarDocumentoContingencia, firmarDocumentoNotaDebito, send_to_mh, send_to_mh_contingencia } from "@/services/DTE.service";
          ...
          <div>
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  {service.get005TipoDeContingencum().map((item) => (
                    <SelectItem className='dark:text-white' key={item.codigo} value={item.codigo}>
                      {item.valores}
                    </SelectItem>
                  ))}
                </Select>
            ...
            <div className="mt-4">
              <div className="flex justify-between">
                <p className="font-semibold text-lg dark:text-white">Listado de notas de débito en contingencia</p>
                {loading ? (
                  <>
