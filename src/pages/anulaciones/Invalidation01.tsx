            ...
            .then((res) => {
              ...
              toast.promise(
                axios
                  ...
                  .then(async () => {
                    const payload = formatAnnulations01(generate, res.data.selloRecibido!, employeeCode!.id ?? 0, motivo.codigo.toString() ?? 'N/A')
        ...
        {/* :
          (<>
            <Modal isDismissable={false} isOpen={modalInitializate} onClose={() => { setModalInitialize(false), navigate(-1) }}>
              <ModalContent>
                <ModalHeader className='dark:text-white'>Anular</ModalHeader>
                <ModalBody>
                  <Input
                    classNames={{
                    ...
                    isInvalid={employeeError ? true: false}
