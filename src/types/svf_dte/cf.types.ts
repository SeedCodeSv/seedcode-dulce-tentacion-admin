import { FC_DocumentoRelacionadoItems, FC_Emisor, FC_Extension, FC_Identificacion, FC_OtrosDocumentosItems, FC_PagosItems, FC_TributosItems, FC_VentaTercerosItems } from "./fc.types"
...
export interface CF_CuerpoDocumento {
    numItem: number
    tipoItem: number
