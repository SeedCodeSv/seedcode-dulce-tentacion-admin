...
import { IGetPromotionsPaginated, PromotionDiscount } from '../../../types/promotions/promotions.types';
...
export interface IPromotionsStore {
  ...
  getPaginatedPromotions: (page: number, limit: number, branchId: number, type: string) => void;
}
