...
import { DetailOrderItems, PurchaseOrder, PurchaseOrderPayload, UpdatePurchaseItems } from "../../types/purchase_orders.types";
...
export interface PurchaseOrderStore {
    ...
    getPurchaseOrders: (startDate: string, endDate: string, page?: number, limit?: number, supplier?: string) => Promise<void>,
