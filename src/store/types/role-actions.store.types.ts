...
export interface IActionsRolStore {
  ...
  role_actions: IGetIRoleAction | undefined;
  role_actions_by_user: IGetIRoleAction | undefined;
  loading_role_actions: boolean;
  getRoleActionsByRol: (role_id: number) => void;
  OnGetActionsByUser: (user_id: number) => Promise<IGetIRoleAction | undefined>;
  OnGetActionsByUserWithoutLoading: (user_id: number) => Promise<IGetIRoleAction | undefined>;
