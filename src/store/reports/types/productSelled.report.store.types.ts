...
export interface IProductSelledStore {
    ...
    products_selled_detailed: IGetProductsSelled;
    ...
    getProductsSelledDetail: (params: SearchReport) => void
    getProductsSelledDetailExport: (params: SearchReport) => Promise<{ ok: boolean, products_selled: IGetProductsSelled }>
